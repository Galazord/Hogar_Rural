...
public class MyNewsFragment extends Fragment {
    ...
    //--> VARIBALES
    private FrameLayout FLMain_myNews;
    // RecyclerView
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mAuth.getCurrentUser()!=null){
            ...
            FLMain_myNews.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.background_grey));
    ...
    private void initComponent(View view) {
        ...
        FLMain_myNews = view.findViewById(R.id.FLMain_myNews);
        recyclerView = view.findViewById(R.id.myNewsRecyclerView);
